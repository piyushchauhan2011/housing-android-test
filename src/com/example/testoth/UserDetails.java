...
public class UserDetails extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView txtCurrentQuestion = (TextView) findViewById(R.id.currentQuestion);
		TextView txtQuestionsAttempted = (TextView) findViewById(R.id.questionsAttempted);
		TextView txtQuestionsRemaining = (TextView) findViewById(R.id.questionsRemaining);
